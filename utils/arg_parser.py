...
def parse_agrs():
    ...
    parser.add_argument('--embeddings_path', type=str, default='/mnt/saarthak/datasets/REG_test1_processed/20x_512px_0px_overlap/slide_features_titan', help='emb 1 path.')
    ...
    parser.add_argument('--model_save_path', type=str, default='/mnt/surya/projects/Wsi-rgen/saved_models/mi_gen_titan_plus_conch1.5_20250731_1_model.ckpt',
    ...
    parser.add_argument('--results_path', type=str, default='/mnt/surya/projects/Wsi-rgen/results/test/mi_gen_titan_plus_conch1.5_20250731_1', help='results path')
