...
def parse_agrs():
    ...
    parser.add_argument('--embeddings_path', type=str, default='/mnt/saarthak/datasets/REG_train_processed/20x_512px_0px_overlap/slide_features_titan', help='emb 1 path.')
    parser.add_argument('--embeddings_path_2', type=str, default='/mnt/saarthak/datasets/REG_train_processed/20x_512px_0px_overlap/features_conch_v15', help='emb 2 path.')
    ...
    parser.add_argument('--model_save_path', type=str, default='/mnt/surya/projects/Wsi-rgen/saved_models/mi_gen_titan_plus_conch1.5_20250717_2_model.ckpt',
                        help='model save path')
    parser.add_argument('--devices', type=str, default='1,2,3,4', help='devices.')
