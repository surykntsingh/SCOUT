...
def parse_agrs():
    ...
    parser.add_argument('--num_heads', type=int, default=5, help='the number of heads in Transformer.')
    ...
    parser.add_argument('--group_size', type=int, default=5, help='the group size.')
