...
class Trainer:
    ...
    def train(self, model, datamodule, fast_dev_run=False):
        ...
        checkpoint_callback = ModelCheckpoint(
            ...
            monitor="val_beacon",  # Metric to monitor for saving best checkpoints
        ...
        early_stop_callback = EarlyStopping(monitor="val_beacon", min_delta=1e-5, patience=11, verbose=True, mode="min")
