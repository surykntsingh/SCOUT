...
def parse_agrs():
    ...
    parser.add_argument('--max_seq_length', type=int, default=00, help='the maximum sequence length of the reports.')
    ...
    parser.add_argument('--devices', type=str, default='0,1,2', help='learning rate.')
