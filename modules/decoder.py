...
class DecoderLayer(nn.Module):
    ...
    def forward(self, feats, hidden_states, concepts, src_mask, tgt_mask):
        ...
        out = self.sublayer[3](x_img, self.ff_1)
        return out, (x_con, alpha, x_img_attn, x_con_attn)
...
class Decoder(nn.Module):
    ...
    def forward(self, x, hidden_states, concepts, src_mask, tgt_mask):
        ...
        for layer in self.layers:
            x, (x_con, alpha, attn_img, attn_con) = layer(x, hidden_states, concepts, src_mask, tgt_mask)
