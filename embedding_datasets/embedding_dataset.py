...
class EmbeddingDataset(Dataset):
    ...
    def __init__(self, embeddings_path, reports_json_path, tokenizer, max_seq_length, embeddings_path_2, gecko_emb_path):
        ...
        self.__slides = [file.split('.')[0] for file in files if file in files_1 and file in files_2]
    ...
    def __getitem__(self, idx):
        ...
        coords = None
        return slide_id, embedding1[::4,:], embedding2[::4,:], emb_g, emb_gc, coords, report_ids, report_masks, seq_length
