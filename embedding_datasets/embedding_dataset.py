...
class EmbeddingDataset(Dataset):
    ...
    def get_slides(self, dataset_type, reports_json_path, embeddings_path, embeddings_path_2,
                   gecko_emb_path):
        reports = read_json_file(reports_json_path)[dataset_type]
    ...
    def get_slides_brca(self, dataset_type, reports_json_path, embeddings_path, embeddings_path_2,
                   gecko_emb_path):
        reports = read_json_file(reports_json_path)[dataset_type]
